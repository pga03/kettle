...
kettle.dataSource.URL.handle.http = function (path, options, data) {
    ...
    var promise = fluid.promise(),
        ...
        httpCallback = function (res) {
            fluid.log("kettle.dataSource.URL.handle.http->httpCallback: res: " + JSON.stringify(res, null, 2));
            var received = "";
    ...
    fluid.log("kettle.dataSource.URL.handle.http: requestOptions: " + JSON.stringify(urlObj, null, 2));
